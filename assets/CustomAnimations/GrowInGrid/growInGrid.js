...
{
  TweenMax.to(selectedArray[i], 2, {css:{backgroundColor:"rgba(255, 255, 153, 1)",zIndex:1, scale: 1.1}, delay: 3}); /*zIndex is important. It  sets the elements to a new layer, so they wont affect the other elements when growing*/
/*}
...
*/
TweenMax.to(selectedArray, 2, {css:{backgroundColor:"rgba(255, 255, 153, 1)",zIndex:1, scale: 1.1}, delay: 3});
TweenMax.to(notSelectedArray, 2, {css:{backgroundColor:"rgba(235, 235, 224, .85)", opacity: 0.2}, delay:3});
